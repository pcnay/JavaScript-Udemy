...
// Obtener el texto a la etiqueta "h1"
// Pero si en el CSS esta asignada la propiedad "visibility:hidden" no lo mostrara.
console.log(encabezado.innerText);

// Pero si en el CSS esta asignada la propiedad "visibility:hidden" lo mostrará.
console.log (encabezado.textContent);

// Tambien se puede realizar de esta manera 
// Se le conoce como Chaining.
const encabezado2 = document.querySelector('.contenido-hero h1').textContent;
console.log (encabezado2);

// Obtiene el texto y las etiquetas HTML.
console.log (encabezado.innerHTML);


// Asignando texto a la etiqueta "h1".
document.querySelector('.contenido-hero h1').textContent = 'Nuevo Titulo del H1';
